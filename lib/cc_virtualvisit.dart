...
void main() {
  runApp(const MaterialApp(home: VirtualVisitPage()));
}
  ...
  void _confirmSchedule() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text("Confirm Virtual Visit Details", style: TextStyle(fontFamily: 'Inter')),
        content: Column(
            ...
            onPressed: () {
              setState(() {
                _events.add(CalendarEvent(
                  ...
                  time: selectedTime!,
                  title: 'Virtual visit',
                  subtitle: selectedVirtualPlatform!,
                ));
              });
          ...
          children: [
            ...
            Container(
              ...
              child: DropdownButton<String>(
                value: selectedVirtualPlatform,
                isExpanded: true,
                underline: const SizedBox(),
                items: ['Sta. Cruz Police Station 3', 'Gandara Police Community Precinct', 'Raxabago-Tondo Police Station']
                    .map((platform) => DropdownMenuItem(value: platform, child: Text(platform, style: const TextStyle(fontFamily: 'Inter'))))
                    .toList(),
                onChanged: (value) => setState(() => selectedVirtualPlatform = value),
              ),
            ),
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Your virtual visit has been scheduled.', // Simpleng mensahe lang
